...
##Problem Statement:
A nightly billing job needs to update 1 million records. It crashed midway last week and the entire job had to restart from scratch. Write a SQL script that commits 1 million transactions efficiently. Your script should handle failures gracefully so the entire job never needs to restart from zero. Explain every decision you made and why.
